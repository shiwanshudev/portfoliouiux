    ...
    <section id="about" className="mx-auto max-w-6xl px-4 md:px-6 scroll-mt-24">
      <Reveal>
        <div className="mb-12 md:mb-16 max-w-3xl">
          <h3 className="text-xs font-mono font-semibold tracking-widest uppercase text-secondary mb-3">
            Workflow
          </h3>
          <h2 className="text-3xl md:text-4xl font-display font-bold tracking-tight mb-4 text-foreground">
            I don't just prompt.<br />I build.
          </h2>
        ...
        <div className="rounded-3xl border border-card-border bg-card-bg p-6 md:p-12 shadow-2xl">
            ...
            {tools.map((tool, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-secondary-text">{tool.name}</span>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              <div className="text-primary font-mono text-sm font-bold mb-3">01</div>
              <h4 className="text-base font-bold text-foreground mb-2">Explore fast</h4>
            ...
            <div>
              <div className="text-primary font-mono text-sm font-bold mb-3">02</div>
              <h4 className="text-base font-bold text-foreground mb-2">Refine by hand</h4>
              <p className="text-sm text-foreground/65 leading-relaxed">
            ...
            <div>
              <div className="text-primary font-mono text-sm font-bold mb-3">03</div>
              <h4 className="text-base font-bold text-foreground mb-2">Ship with intent</h4>
              <p className="text-sm text-foreground/65 leading-relaxed">
