          ...
          <div className="order-2 md:order-1">
            <Reveal>
              ...
              <div className="mt-6 md:mt-8 flex flex-col sm:flex-row gap-3 md:gap-4">
                <a
                  href="#projects"
                  className="rounded-full border-2 border-blue-600 bg-transparent px-6 md:px-8 py-3 text-sm font-semibold text-blue-600 transition-all duration-300 hover:bg-blue-50 hover:scale-105 transform-gpu dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/20 text-center"
                >
                  View Work
                </a>
                <a
